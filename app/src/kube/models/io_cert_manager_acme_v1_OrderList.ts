import type { io_cert_manager_acme_v1_Order } from './io_cert_manager_acme_v1_Order';
 ...
 */
export type io_cert_manager_acme_v1_OrderList = {
	/**
	 ...
	 */
	items: Array<io_cert_manager_acme_v1_Order>;
	/**
