import type { io_cert_manager_v1_ClusterIssuer } from './io_cert_manager_v1_ClusterIssuer';
 ...
 */
export type io_cert_manager_v1_ClusterIssuerList = {
	/**
	 ...
	 */
	items: Array<io_cert_manager_v1_ClusterIssuer>;
	/**
