import type { io_cilium_v2_CiliumNetworkPolicy } from './io_cilium_v2_CiliumNetworkPolicy';
 ...
 */
export type io_cilium_v2_CiliumNetworkPolicyList = {
	/**
	 ...
	 */
	items: Array<io_cilium_v2_CiliumNetworkPolicy>;
	/**
