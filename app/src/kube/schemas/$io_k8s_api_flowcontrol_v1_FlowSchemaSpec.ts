export const $io_k8s_api_flowcontrol_v1_FlowSchemaSpec = {
	description: `FlowSchemaSpec describes how the FlowSchema's specification looks like.`,
	properties: {
		distinguisherMethod: {
	type: 'io_k8s_api_flowcontrol_v1_FlowDistinguisherMethod',
	...
	type: 'io_k8s_api_flowcontrol_v1_PriorityLevelConfigurationReference',
	...
	type: 'array',
	contains: {
		type: 'io_k8s_api_flowcontrol_v1_PolicyRulesWithSubjects',
	},
},
	},
} as const;