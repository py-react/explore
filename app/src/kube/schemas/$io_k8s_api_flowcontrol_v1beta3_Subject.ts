export const $io_k8s_api_flowcontrol_v1beta3_Subject = {
	...
	properties: {
		group: {
	type: 'io_k8s_api_flowcontrol_v1beta3_GroupSubject',
	...
	isRequired: true,
		...
		serviceAccount: {
	type: 'io_k8s_api_flowcontrol_v1beta3_ServiceAccountSubject',
	description: `\`serviceAccount\` matches ServiceAccounts.`,
},
		user: {
	type: 'io_k8s_api_flowcontrol_v1beta3_UserSubject',
