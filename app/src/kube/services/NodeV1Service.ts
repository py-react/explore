...
export type TDataListNodeV1RuntimeClass = {
                /**
...
export type TDataCreateNodeV1RuntimeClass = {
...
export type TDataDeleteNodeV1CollectionRuntimeClass = {
                /**
 * The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
 * 
 * This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
...
export type TDataReadNodeV1RuntimeClass = {
                /**
...
export type TDataReplaceNodeV1RuntimeClass = {
                body: io_k8s_api_node_v1_RuntimeClass
/**
 * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
...
export type TDataDeleteNodeV1RuntimeClass = {
                body?: io_k8s_apimachinery_pkg_apis_meta_v1_DeleteOptions
/**
 * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
...
export type TDataPatchNodeV1RuntimeClass = {
...
export type TDataWatchNodeV1RuntimeClassList = {
                /**
 * The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
 * 
 * This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
...
export type TDataWatchNodeV1RuntimeClass = {
                /**
 * The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
 * 
 * This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
...
export class NodeV1Service {
	 ...
	 * @throws ApiError
	 */
	public static getNodeV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
	 ...
	 * @throws ApiError
	 */
	public static listNodeV1RuntimeClass(data: TDataListNodeV1RuntimeClass = {}): CancelablePromise<io_k8s_api_node_v1_RuntimeClassList> {
		const {
_continue,
allowWatchBookmarks,
fieldSelector,
...
watch,
	 ...
	 * @throws ApiError
	 */
	public static createNodeV1RuntimeClass(data: TDataCreateNodeV1RuntimeClass): CancelablePromise<io_k8s_api_node_v1_RuntimeClass> {
		const {
body,
dryRun,
fieldManager,
...
pretty,
	 ...
	 * @throws ApiError
	 */
	public static deleteNodeV1CollectionRuntimeClass(data: TDataDeleteNodeV1CollectionRuntimeClass = {}): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_Status> {
		const {
_continue,
body,
dryRun,
...
timeoutSeconds,
	 ...
	 * @throws ApiError
	 */
	public static readNodeV1RuntimeClass(data: TDataReadNodeV1RuntimeClass): CancelablePromise<io_k8s_api_node_v1_RuntimeClass> {
		const {
name,
pretty,
} = data;
	 ...
	 * @throws ApiError
	 */
	public static replaceNodeV1RuntimeClass(data: TDataReplaceNodeV1RuntimeClass): CancelablePromise<io_k8s_api_node_v1_RuntimeClass> {
		const {
body,
dryRun,
fieldManager,
...
pretty,
	 ...
	 * @throws ApiError
	 */
	public static deleteNodeV1RuntimeClass(data: TDataDeleteNodeV1RuntimeClass): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_Status> {
		const {
body,
dryRun,
gracePeriodSeconds,
...
propagationPolicy,
	 ...
	 * @throws ApiError
	 */
	public static patchNodeV1RuntimeClass(data: TDataPatchNodeV1RuntimeClass): CancelablePromise<io_k8s_api_node_v1_RuntimeClass> {
		const {
body,
dryRun,
fieldManager,
...
pretty,
	 ...
	 * @throws ApiError
	 */
	public static watchNodeV1RuntimeClassList(data: TDataWatchNodeV1RuntimeClassList = {}): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_WatchEvent> {
		const {
_continue,
allowWatchBookmarks,
fieldSelector,
...
watch,
	 ...
	 * @throws ApiError
	 */
	public static watchNodeV1RuntimeClass(data: TDataWatchNodeV1RuntimeClass): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_WatchEvent> {
		const {
_continue,
allowWatchBookmarks,
fieldSelector,
